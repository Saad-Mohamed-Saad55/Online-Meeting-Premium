...
export default function DropDown({
  ...
  }, [selectedSpeaker.id, recordingDuration]);
                    ...
                    <div>
                      <div className="flex flex-col">
                        ...
                        {micOn ? <div className="my-1 pr-2 text-white flex flex-1 w-full text-left mb-2 pl-4">
                          ...
                          <span className="mr-2">
                            {volume && volume > 5 ? (
                              <TestMic className="text-white" />
                            ) : (
                              <TestMicOff className="text-white" />
                            )}
                          </span>

                          <div className="flex-1 overflow-hidden whitespace-nowrap overflow-ellipsis flex items-center">
                            {!recordingStatus.startsWith("playing") ? (
                              <button
                                onClick={() => {
                                  if (recordingStatus === "inactive") {
                                    ...
                                    stopRecording();
                                  } else if (recordingStatus === "stopped recording") {
                                    handlePlaying();
                                  }
                                }}
                                className={`rounded-full flex-1 text-sm flex items-center justify-center ${recordingStatus === "recording" ? "text-red-500" : "text-green-500"
                                  }`}
                              >
                              ...
                              <div className="relative w-full">
                                <div className="absolute top-0 left-0 h-full bg-green-500" style={{ width: `${audioProgress}%` }}></div>
